                                                ...
                                                <td colspan="4">&nbsp;</td>
                                                   <td colspan="2">
                                                           <table class="table table-condensed total-result">
                                                                ...
                                                                <tr>
                                                                <td>Token Confirmasi</td>
                                                                        <p>Silahkan masukan token ini untuk melakukan konfirmasi pembayaran</p>
                                                                        <td><span>{{$ckt->id_checkout}}</span></td>
                                                                </tr>
                                                        </table>
                                                   </td>
                                           </tr> --}}
                                ...
                                <div class="total_area">
                                        <ul>
                                                <table class="table table-condensed total-result">
                                                        ...
                                                        <tr>
                                                            <td>Token Confirmasi</td>
                                                                <p class="text-center">Silahkan masukan token ini untuk melakukan konfirmasi pembayaran</p>
                                                            <td><span>{{$ckt->id_checkout}}</span></td>
                                                        </tr>
                                                </table>   
                                        </ul>
                                        <a class="btn btn-default check_out" href="/confirm">Kofimarmasi Pesanan</a>
                                </div>
                        </div>
                </div>
        </div>
